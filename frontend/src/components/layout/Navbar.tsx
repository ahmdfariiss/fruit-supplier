...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-[18px] left-1/2 -translate-x-1/2 z-[999] w-[calc(100%-40px)] max-w-[1080px]">
      <nav
        className={`
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {cartItems() > 0 && (
              <span className="absolute top-0.5 right-0.5 w-[15px] h-[15px] rounded-full bg-[#e84d1c] text-white text-[0.55rem] font-extrabold flex items-center justify-center border-2 border-white">
                {cartItems()}
              </span>
            )}
          </Link>
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="md:hidden mt-3 bg-white/95 backdrop-blur-xl rounded-3xl border border-white/90 shadow-lg p-5">
