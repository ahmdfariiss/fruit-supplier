...
import { BrainIcon, InfoIcon } from '@/components/ui/icons';
        ...
        <div className="bg-white rounded-2xl border border-faint p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Buah apa yang kaya vitamin C?"
              rows={2}
          ...
          <div className="mb-4">
            <label className="block text-xs font-extrabold uppercase tracking-wider text-muted mb-2">
              Pilihan Jawaban *{' '}
              <span className="text-g2 normal-case font-semibold ml-1">
                ...
                <div key={i} className="flex items-center gap-2.5">
                  ...
                  <input
                    ...
                    className={`flex-1 px-3.5 py-2.5 border rounded-xl text-sm outline-none transition-colors ${
                      form.correctIndex === i
                        ? 'border-g3 bg-g6'
                        : 'border-faint focus:border-g3'
                    }`}
                  />
                  {form.correctIndex === i && (
                    <span className="text-xs font-bold text-g1 flex-shrink-0">
                      ✓ Benar
                    </span>
                  )}
                </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-muted">
            <span className="block mb-2">
              <BrainIcon className="w-8 h-8 mx-auto" />
            </span>
          ...
          <div className="divide-y divide-faint">
            {questions.map((q, idx) => (
              <div key={q.id} className="p-5">
                ...
                {q.explanation && (
                  <p className="ml-10 mt-2 text-xs text-muted italic inline-flex items-center gap-1">
                    <InfoIcon className="w-3.5 h-3.5" /> {q.explanation}
                  </p>
                )}
              </div>
            ))}
      ...
      >
        <p className="text-sm text-muted mb-5">
          ...
          <span className="font-bold text-ink">
            &quot;{deleteTarget?.question?.substring(0, 50)}...&quot;
          </span>
          ?
        </p>
        <div className="flex gap-3">
